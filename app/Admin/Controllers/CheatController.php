...
use App\DataModels\Cheat as DataCheat;
...
class CheatController extends AdminController
{
    ...
    {
        $form = new Form(new Cheat());

        $form->text('tgid', __('tgid'))->rules('required|unique:cheats', [
            'required' => 'tgid不能为空',
            'unique' => 'tgid已存在',
        ]);
    ...
    public function save()
    {
        ...
        CheatService::create($tgid, $admin["id"], $reason);
    ...
    public function store()
    {
        ...
        LogOperationService::create([
            "type" => LogOperationService::$type_in_cheat,
