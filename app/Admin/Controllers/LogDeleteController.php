...
use App\Models\LogDeleteMessage;
use Encore\Admin\Grid;
use App\Service\OfficialUserService;
use App\Models\AdminUser;


class LogDeleteController extends AdminController
{
    protected $title = '删除信息日志';
    ...
    {
        $grid = new Grid(new LogDeleteMessage());
        $grid->model()
        ...
        $grid->filter(function ($filter) {
            ...
            $filter->column(1 / 2, function ($filter) {
                ...
                $filter->equal('message_tg_id', "信息tgid");
            });
        });
        ...
        $grid->column('message_tg_id', __('信息tgid'));
