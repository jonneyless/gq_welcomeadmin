...
use App\Models\LogCancelRestrictUser;
use Encore\Admin\Grid;
use App\Service\OfficialUserService;
use App\Models\AdminUser;


class LogCancelrestrictController extends AdminController
{
    protected $title = '取消禁言日志';
    ...
    {
        $grid = new Grid(new LogCancelRestrictUser());
        $grid->model()
