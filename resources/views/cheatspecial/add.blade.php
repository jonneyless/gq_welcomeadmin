    ...
    <div class="box-header with-border">
        ...
        <div class="box-tools">
            <div class="btn-group pull-right" style="margin-right: 5px">
                <a href="/E9hzf/cheatspecial" class="btn btn-sm btn-default"
                   title="列表"><i class="fa fa-list"></i><span class="hidden-xs">&nbsp;列表</span></a>
            </div>
        </div>
    </div>
    <div action="/E9hzf/cheatspecial" method="post"
...
<script>
    $(function () {
        $(".submit").click(function () {
            ...
            let reason = $("input[id='reason']").val();
            ...
            $.ajax({
                type: "post",
                data: data1,
                "url": "{{adminUrl('cheatspecial/save')}}",
                success: function (data) {
                    ...
                    if (msg == "admin") {
                        ...
                        let layer1 = layer.confirm("该用户是管理，确认加入担保骗子库？", function () {
