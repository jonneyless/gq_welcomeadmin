    ...
    $(function () {
        ...
        $(".deleteAndRestrict").click(function () {
            layer.prompt({title: '禁言天数，仅允许输入数字', formType: 0}, function (pass, index) {
                ...
                $.ajax({
                    url: '{{ adminUrl("user/deleteAndRestrict")}}',
                    type: "post",
                    data: data,
                    success: function (result) {
                        layer.close(index_load);
        ...
        $(".cancelRestrict").click(function () {
            ...
            $.ajax({
                url: '{{ adminUrl("user/cancelRestrict")}}',
                type: "post",
                data: data,
                success: function (result) {
                    layer.close(index_load);
        ...
        $(".deleteAndKick").click(function () {
            ...
            $.ajax({
                url: '{{ adminUrl("user/deleteAndKick")}}',
                type: "post",
                data: data,
                success: function (result) {
                    layer.close(index_load);
