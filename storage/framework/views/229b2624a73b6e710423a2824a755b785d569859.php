    ...
    $(function () {
        ...
        function loadData() {
            ...
            $.ajax({
                ...
                url: '<?php echo e(adminUrl("msg/search")); ?>',
        ...
        $(".delete").click(function () {
            ...
            $.ajax({
                url: '<?php echo e(adminUrl("msg/delete")); ?>',
                type: "post",
                data: data,
                success: function (result) {
                    layer.close(index_load);
        ...
        $(".kick").click(function () {
            ...
            $.ajax({
                url: '<?php echo e(adminUrl("msg/kick")); ?>',
                type: "post",
                data: data,
                success: function (result) {
                    layer.close(index_load);
        ...
        $(".restrict").click(function () {
            layer.prompt({title: '禁言天数，仅允许输入数字', formType: 0}, function (pass, index) {
                ...
                $.ajax({
                    url: '<?php echo e(adminUrl("msg/restrict")); ?>',
                    type: "post",
                    data: data,
                    success: function (result) {
                        layer.close(index_load);
        ...
        $(".addCheat").click(function () {
            ...
            layer.prompt({title: '请输入加入骗子库原因', formType: 0}, function (pass, index) {
                ...
                $.ajax({
                    url: '<?php echo e(adminUrl("msg/addCheat")); ?>',
                    type: "post",
                    data: data,
                    success: function (result) {
                        layer.close(index_load);
