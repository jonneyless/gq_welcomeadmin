...
<input name="chat_id" type="hidden" value="<?php echo e($group["chat_id"]); ?>">
<input name="title" type="hidden" value="<?php echo e($group["title"]); ?>">
<input name="welcome_info" type="hidden" value="<?php echo e($group["welcome_info"]); ?>">
<input name="description" type="hidden" value="<?php echo e($group["description"]); ?>">
<input name="rules" type="hidden" value="<?php echo e($group["rules"]); ?>">
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="test1" style="padding-left: 10px;">
                    <div class="row" style="margin-bottom: -15px;">
                        <div class="col-sm-5">
                            <dl>
                                <dd>chat_id：<?php echo e($group["chat_id"]); ?></dd>
                                <br/>
                                <dd>群名：<?php echo e($group["title"]); ?>
                                ...
                                <dd>
                                    ...
                                    <div class="form-group" style="display: inline-block;">
                                        <label>
                                            <input type="radio" name="r1" class="flag" <?php if($group["flag"] == 1): ?> checked
                                                   <?php endif; ?> value="1">
                                            待定
                                        </label>
                                        &nbsp;&nbsp;&nbsp;
                                        <label>
                                            <input type="radio" name="r1" class="flag" <?php if($group["flag"] == 2): ?> checked
                                                   <?php endif; ?> value="2">
                                            真公群
                                        </label>
                                        &nbsp;&nbsp;&nbsp;
                                        <label>
                                            <input type="radio" name="r1" class="flag" <?php if($group["flag"] == 4): ?> checked
                                                   <?php endif; ?> value="4">
                                            游戏群
                                        </label>
                                        &nbsp;&nbsp;&nbsp;
                                        <label>
                                            <input type="radio" name="r1" class="flag" <?php if($group["flag"] == 3): ?> checked
                                                   <?php endif; ?> value="3">
                                            骗子群
                                        </label>
                                    </div>
                                ...
                                <dd>
                                    ...
                                    <div class="form-group" style="display: inline-block;">
                                        <label>
                                            <input type="radio" name="rb1" class="business_type" <?php if($group["business_type"] == 10): ?> checked
                                                   <?php endif; ?> value="10">
                                            代付代收群
                                        </label>
                                        &nbsp;&nbsp;&nbsp;
                                ...
                                <dd>
                                    ...
                                    <div class="form-group" style="display: inline-block;width: 300px;">
                                        <select class="form-control business_detail_type" style="width: 100%;">
                                            <option value="1" <?php if($group["business_detail_type"] == 1): ?> selected <?php endif; ?>>待定（默认）</option>
                                            <option disabled>代收类</option>
                                            <option value="100" <?php if($group["business_detail_type"] == 100): ?> selected <?php endif; ?>>-卡接一道回u</option>
                                            <option value="101" <?php if($group["business_detail_type"] == 101): ?> selected <?php endif; ?>>-码接回u</option>
                                            <option value="102" <?php if($group["business_detail_type"] == 102): ?> selected <?php endif; ?>>-卡接二道回u</option>
                                            <option disabled>承兑类</option>
                                            <option value="200" <?php if($group["business_detail_type"] == 200): ?> selected <?php endif; ?>>-支付宝微信</option>
                                            <option value="201" <?php if($group["business_detail_type"] == 201): ?> selected <?php endif; ?>>-现存承兑</option>
                                            <option value="202" <?php if($group["business_detail_type"] == 202): ?> selected <?php endif; ?>>-pos和备付金</option>
                                            <option value="203" <?php if($group["business_detail_type"] == 203): ?> selected <?php endif; ?>>-多种资金</option>
                                            <option value="204" <?php if($group["business_detail_type"] == 204): ?> selected <?php endif; ?>>-海外直通车</option>
                                            <option disabled>收u代付类</option>
                                            <option value="800" <?php if($group["business_detail_type"] == 800): ?> selected <?php endif; ?>>-保7天以上</option>
                                            <option value="801" <?php if($group["business_detail_type"] == 801): ?> selected <?php endif; ?>>-保当天</option>
                                            <option value="802" <?php if($group["business_detail_type"] == 802): ?> selected <?php endif; ?>>-二道混料</option>
                                            <option value="803" <?php if($group["business_detail_type"] == 803): ?> selected <?php endif; ?>>-一道放料</option>
                                            <option value="804" <?php if($group["business_detail_type"] == 804): ?> selected <?php endif; ?>>-其他资金</option>
                                            <option disabled>合作类</option>
                                            <option value="300" <?php if($group["business_detail_type"] == 300): ?> selected <?php endif; ?>>-卡商中介</option>
                                            <option value="301" <?php if($group["business_detail_type"] == 301): ?> selected <?php endif; ?>>-固话手机口</option>
                                            <option value="302" <?php if($group["business_detail_type"] == 302): ?> selected <?php endif; ?>>-app跑分</option>
                                            <option value="303" <?php if($group["business_detail_type"] == 303): ?> selected <?php endif; ?>>-招车队</option>
                                            <option value="304" <?php if($group["business_detail_type"] == 304): ?> selected <?php endif; ?>>-贴卡片</option>
                                            <option disabled>服务类</option>
                                            <option value="400" <?php if($group["business_detail_type"] == 400): ?> selected <?php endif; ?>>-查档</option>
                                            <option value="401" <?php if($group["business_detail_type"] == 401): ?> selected <?php endif; ?>>-飞机会员</option>
                                            <option value="402" <?php if($group["business_detail_type"] == 402): ?> selected <?php endif; ?>>-票务酒店</option>
                                            <option value="403" <?php if($group["business_detail_type"] == 403): ?> selected <?php endif; ?>>-设计美工</option>
                                            <option value="404" <?php if($group["business_detail_type"] == 404): ?> selected <?php endif; ?>>-搭建开发</option>
                                            <option disabled>买卖类</option>
                                            <option value="500" <?php if($group["business_detail_type"] == 500): ?> selected <?php endif; ?>>-QQ/微信/手机卡</option>
                                            <option value="501" <?php if($group["business_detail_type"] == 501): ?> selected <?php endif; ?>>-卖数据</option>
                                            <option value="502" <?php if($group["business_detail_type"] == 502): ?> selected <?php endif; ?>>-能量trx</option>
                                            <option value="600" <?php if($group["business_detail_type"] == 600): ?> selected <?php endif; ?>>其他类</option>
                                            <option value="700" <?php if($group["business_detail_type"] == 700): ?> selected <?php endif; ?>>vip小公群</option>
                                            
                                            <option value="1000" <?php if($group["business_detail_type"] == 1000): ?> selected <?php endif; ?>>资源群</option>
                                        </select>
                                    </div>
                                </dd>
                                <dd>
                                    报备报警比例(0-1)：
                                    <div class="form-group" style="display: inline-block;">
                                        <label><?php echo e($group["trade_rate"]); ?></label>
                                ...
                                <dd>
                                    ...
                                    <div class="form-group" style="display: inline-block;">
                                        <label>
                                            <input type="radio" name="rm5" class="status_in" <?php if($group["status_in"] == 1): ?> checked
                                                   <?php endif; ?> value="1">
                                            在
                                        </label>
                                        &nbsp;&nbsp;&nbsp;
                                        <label>
                                            <input type="radio" name="rm55" class="status_in" <?php if($group["status_in"] == 2): ?> checked
                                                   <?php endif; ?> value="2">
                                            不在
                                        </label>
                                        &nbsp;&nbsp;&nbsp;
                                        <label>
                                            <input type="radio" name="rm55" class="status_in" <?php if($group["status_in"] == 3): ?> checked
                                                   <?php endif; ?> value="3">
                                            待判断
                                        </label>
                                    </div>
                                ...
                                <dd>
                                    ...
                                    <div class="form-group" style="display: inline-block;">
                                        <label>
                                            <input type="radio" name="rm" class="statusMoney" <?php if($group["status_money"] == 3): ?> checked
                                                   <?php endif; ?> value="3">
                                            待定
                                        </label>
                                        &nbsp;&nbsp;&nbsp;
                                        <label>
                                            <input type="radio" name="rm" class="statusMoney" <?php if($group["status_money"] == 1): ?> checked
                                                   <?php endif; ?> value="1">
                                            已上押
                                        </label>
                                        &nbsp;&nbsp;&nbsp;
                                        <label>
                                            <input type="radio" name="rm" class="statusMoney" <?php if($group["status_money"] == 2): ?> checked
                                                   <?php endif; ?> value="2">
                                            已退押
                                        </label>
                                    </div>
                                    ...
                                    <div class="form-group" style="display: inline-block;">
                                        <label>
                                            <input type="radio" name="r3" class="people_limit"
                                                   <?php if($group["people_limit"] == 1): ?> checked
                                                   <?php endif; ?> value="1">
                                            进群自动禁言
                                        </label>
                                        &nbsp;&nbsp;&nbsp;
                                        <label>
                                            <input type="radio" name="r3" class="people_limit"
                                                   <?php if($group["people_limit"] == 3): ?> checked
                                                   <?php endif; ?> value="3">
                                            进群验证
                                        </label>
                                        &nbsp;&nbsp;&nbsp;
                                        <label>
                                            <input type="radio" name="r3" class="people_limit"
                                                   <?php if($group["people_limit"] == 2): ?> checked
                                                   <?php endif; ?> value="2">
                                            关闭
                                        </label>
                                    </div>
                                    ...
                                    <div class="form-group" style="display: inline-block;">
                                        <label>
                                            <input type="radio" name="r4" class="welcome_status"
                                                   <?php if($group["welcome_status"] == 1): ?> checked
                                                   <?php endif; ?> value="1">
                                            开启
                                        </label>
                                        &nbsp;&nbsp;&nbsp;
                                        <label>
                                            <input type="radio" name="r4" class="welcome_status"
                                                   <?php if($group["welcome_status"] == 2): ?> checked
                                                   <?php endif; ?> value="2">
                                            关闭
                                        </label>
                                    </div>
                                ...
                                <dd>
                                    欢迎语频率(秒)：
                                    <div class="form-group" style="display: inline-block;">
                                        <label><?php echo e($group["limit_one_time"]); ?></label>
                                    ...
                                    群编号：
                                    <div class="form-group" style="display: inline-block;">
                                        <label><?php echo e($group["group_num"]); ?></label>
                                    ...
                                    <div class="form-group" style="display: inline-block;">
                                        <label>
                                            <input type="radio" name="r2" class="trade_type"
                                                   <?php if($group["trade_type"] == 1): ?> checked
                                                   <?php endif; ?> value="1">
                                            待定
                                        </label>
                                        &nbsp;&nbsp;&nbsp;
                                        <label>
                                            <input type="radio" name="r2" class="trade_type"
                                                   <?php if($group["trade_type"] == 2): ?> checked
                                                   <?php endif; ?> value="2">
                                            代收群
                                        </label>
                                        &nbsp;&nbsp;&nbsp;
                                        <label>
                                            <input type="radio" name="r2" class="trade_type"
                                                   <?php if($group["trade_type"] == 3): ?> checked
                                                   <?php endif; ?> value="3">
                                            代付群
                                        </label>
                                        &nbsp;&nbsp;&nbsp;
                                        <label>
                                            <input type="radio" name="r2" class="trade_type"
                                                   <?php if($group["trade_type"] == 4): ?> checked
                                                   <?php endif; ?> value="4">
                                            支付宝
                                        </label>
                                        &nbsp;&nbsp;&nbsp;
                                        <label>
                                            <input type="radio" name="r2" class="trade_type"
                                                   <?php if($group["trade_type"] == 9): ?> checked
                                                   <?php endif; ?> value="9">
                                            全部
                                        </label>
                                    </div>
                                    ...
                                    <div class="form-group" style="display: inline-block;">
                                        <label>
                                            <input type="radio" name="r99" class="send_user_change"
                                                   <?php if($group["send_user_change"] == 1): ?> checked
                                                   <?php endif; ?> value="1">
                                            开启
                                        </label>
                                        &nbsp;&nbsp;&nbsp;
                                        <label>
                                            <input type="radio" name="r99" class="send_user_change"
                                                   <?php if($group["send_user_change"] == 2): ?> checked
                                                   <?php endif; ?> value="2">
                                            关闭
                                        </label>
                                    </div>
                                    ...
                                    <div class="form-group" style="display: inline-block;">
                                        <label>
                                            <input type="radio" name="r99" class="status_follow"
                                                   <?php if($group["status_follow"] == 1): ?> checked
                                                   <?php endif; ?> value="1">
                                            开启
                                        </label>
                                        &nbsp;&nbsp;&nbsp;
                                        <label>
                                            <input type="radio" name="r99" class="status_follow"
                                                   <?php if($group["status_follow"] == 2): ?> checked
                                                   <?php endif; ?> value="2">
                                            关闭
                                        </label>
                                    </div>
                                    ...
                                    <div class="form-group" style="display: inline-block;">
                                        <label>
                                            <input type="radio" name="r91" class="xianjing_status"
                                                   <?php if($group["xianjing_status"] == 1): ?> checked
                                                   <?php endif; ?> value="1">
                                            开启
                                        </label>
                                        &nbsp;&nbsp;&nbsp;
                                        <label>
                                            <input type="radio" name="r91" class="xianjing_status"
                                                   <?php if($group["xianjing_status"] == 2): ?> checked
                                                   <?php endif; ?> value="2">
                                            关闭
                                        </label>
                                    </div>
                        ...
                        <div class="col-sm-7">
                                ...
                                <dd>1. 名字含中文且手动通过两个(非游戏群)公群的入群申请的用户自动审核通过
                                    ...
                                    <label>
                                        <input type="radio" name="status_approve_one"
                                               ...
                                               <?php if($group["status_approve_one"] == 1): ?> checked
                                               <?php endif; ?> value="1">
                                        开启
                                    </label>
                                    &nbsp;&nbsp;&nbsp;
                                ...
                                <dd>2. 名字含中文的自动审核通过
                                    ...
                                    <label>
                                        <input type="radio" name="status_approve_two"
                                               ...
                                               <?php if($group["status_approve_two"] == 1): ?> checked
                                               <?php endif; ?> value="1">
                                        开启
                                    </label>
                                    &nbsp;&nbsp;&nbsp;
                                ...
                                <dd>3. 名字不含中文的自动拒绝
                                    ...
                                    <label>
                                        <input type="radio" name="status_approve_three"
                                               ...
                                               <?php if($group["status_approve_three"] == 1): ?> checked
                                               <?php endif; ?> value="1">
                                        开启
                                    </label>
                                    &nbsp;&nbsp;&nbsp;
                                ...
                                <dd>4. 黑名单里面的用户自动拒绝
                                    ...
                                    <label>
                                        <input type="radio" name="status_approve_four"
                                               ...
                                               <?php if($group["status_approve_four"] == 1): ?> checked
                                               <?php endif; ?> value="1">
                                        开启
                                    </label>
                                    &nbsp;&nbsp;&nbsp;
                                ...
                                <dd>5. 白名单, 官方账号自动通过
                                    ...
                                    <label>
                                        <input type="radio" name="status_approve_five"
                                               ...
                                               <?php if($group["status_approve_five"] == 1): ?> checked
                                               <?php endif; ?> value="1">
                                        开启
                                    </label>
                                    &nbsp;&nbsp;&nbsp;
                                ...
                                <dd>6. VIP群和高级用户对接群用户自动审核通过
                                    ...
                                    <label>
                                        <input type="radio" name="status_approve_vip"
                                               ...
                                               <?php if($group["status_approve_vip"] == 1): ?> checked
                                               <?php endif; ?> value="1">
                                        开启
                                    </label>
                                    &nbsp;&nbsp;&nbsp;
                            ...
                            <?php if(count($reports) > 0): ?>
                                <div>
                                    <p>押金：<?php echo e($money_yajin); ?></p>
                                    <p>交易完成：<?php echo e($money_over); ?></p>
                                    <p>交易中：<?php echo e($money_in); ?></p>
                                    <p>剩下可报备金额：<?php echo e($money_sub); ?></p>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
                         ...
                         <div class="col-sm-12">
                            ...
                            <table class="table table-bordered" style="width: 60%;">
                                ...
                                <?php $__currentLoopData = $admins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $admin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td>
                                            <?php if(!$admin["username"] || trim($admin["username"]) == trim($admin["firstname"] . " ". $admin["lastname"])): ?>
                                        ...
                                        <td>
                                            <span><?php echo e(trim($admin["firstname"] . " ". $admin["lastname"])); ?></span>
                                        </td>
                                        <td>
                                            <?php if($admin["custom_title"]): ?>
                                                <span><?php echo e(trim($admin["custom_title"])); ?></span>
                                            <?php else: ?>
                                                <span>无</span>
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            <button type="button" user_id="<?php echo e($admin['user_id']); ?>" class="btn btn-default btn-sm setUserTitle">设置头衔</button>
                                        </td>
                                        <td>
                                            <button type="button" user_id="<?php echo e($admin['user_id']); ?>" class="btn btn-default btn-sm edit_admin" admin_user_tg_id="<?php echo e($admin['user_id']); ?>">编辑权限</button>
                                        </td>
                                        <td>
                                            <?php if($admin["status"] == "creator"): ?>
                                                <span style="color: red; font-weight: bold;">群主</span>
                                            <?php else: ?>
                                                <i class="fa fa-remove pointer remove_admin" user_id="<?php echo e($admin['user_id']); ?>">移除管理</i>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                                ...
                                <div class="radio">
                                    <label>
                                        <input class="key" type="radio" name="hour_notice_status"
                                               ...
                                               <?php if($group["hour_notice_status"] == 1): ?>
                                                   checked
                                                <?php endif; ?>
                                        >
                                        开启
                                ...
                                <div class="radio">
                                    <label>
                                        <input class="key" type="radio" name="hour_notice_status"
                                               ...
                                               <?php if($group["hour_notice_status"] == 2): ?>
                                                   checked
                                                <?php endif; ?>
                                        >
                                        关闭
                            ...
                            <div class="form-group">
                                ...
                                <div class="radio">
                                    <label>
                                        <input class="key" type="radio" name="switch_group_status"
                                               ...
                                               <?php if($group["switch_group_status"] == 1): ?>
                                                   checked
                                                <?php endif; ?>
                                        >
                                        开启
                                ...
                                <div class="radio">
                                    <label>
                                        <input class="key" type="radio" name="switch_group_status"
                                               ...
                                               <?php if($group["switch_group_status"] == 2): ?>
                                                   checked
                                                <?php endif; ?>
                                        >
                                        关闭
                                ...
                                <div class="form-group" style="margin-left: 40px;">
                                    ...
                                    <input type="text" id="startTime" name="startTime" autocomplete="off" size="25"
                                           class="startTime" value="<?php echo e($group['started_at']); ?>">
                                    &nbsp;&nbsp;&nbsp;
                                    <span>结束营业时间：</span>
                                    <input type="text" id="endTime" name="endTime" autocomplete="off" size="25"
                                           class="endTime" value="<?php echo e($group['ended_at']); ?>">
                                    &nbsp;&nbsp;&nbsp;
                                ...
                                <div class="radio">
                                    <label>
                                        <input class="key" type="radio" name="welcome_true_status"
                                               ...
                                               <?php if($group["welcome_true_status"] == 1): ?>
                                                   checked
                                                <?php endif; ?>
                                        >
                                        开启
                                ...
                                <div class="radio">
                                    <label>
                                        <input class="key" type="radio" name="welcome_true_status"
                                               ...
                                               <?php if($group["welcome_true_status"] == 2): ?>
                                                   checked
                                                <?php endif; ?>
                                        >
                                        关闭
                                ...
                                <div class="radio">
                                    <label>
                                        <input class="key" type="radio" name="welcome_false_status"
                                               ...
                                               <?php if($group["welcome_false_status"] == 1): ?>
                                                   checked
                                                <?php endif; ?>
                                        >
                                        开启
                                ...
                                <div class="radio">
                                    <label>
                                        <input class="key" type="radio" name="welcome_false_status"
                                               ...
                                               <?php if($group["welcome_false_status"] == 2): ?>
                                                   checked
                                                <?php endif; ?>
                                        >
                                        关闭
    ...
    $(function () {
        ...
        function loadNotice() {
            $('#dataTable2').DataTable({
                ...
                "ajax": {
                    "method": "post",
                    "url": "<?php echo e(adminUrl('group/notice')); ?>",
                    "data": function (d) {
                        return $.extend({}, d, {
                ...
                $("tr").each(function () {
                    $(this).find(".delete").click(function () {
                        ...
                        $.ajax({
                            ...
                            "url": "<?php echo e(adminUrl('group/notice/delete')); ?>",
                            success: function () {
                                layer.close(load);
            ...
            $('#dataTable3').DataTable({
                ...
                "ajax": {
                    "method": "post",
                    "url": "<?php echo e(adminUrl('group/approve')); ?>",
                    "data": function (d) {
                        return $.extend({}, d, {
                            "_token": "<?php echo e(csrf_token()); ?>",
                            "chat_id": $("input[name='chat_id']").val(),
        ...
        $(".add2").click(function () {
            ...
            $("body").off('click', '.notice .submit').on("click", ".notice .submit", function () {
                ...
                $.ajax({
                    ...
                    "url": "<?php echo e(adminUrl('group/notice/add')); ?>",
                    success: function () {
                        layer.close(load);
                        layer.close(layer1);
        ...
        $(".kickAll").click(function () {
            let layer1 = layer.confirm("踢出群组内所有非管理员用户？", function () {
                ...
                $.ajax({
                    ...
                    "url": "<?php echo e(adminUrl('group/kickAll')); ?>",
                    success: function () {
                        layer.close(layer2);
                        layer.close(layer1);
        ...
        $(".unban").click(function () {
            let layer1 = layer.confirm("移除该群所有黑名单？", function () {
                ...
                $.ajax({
                    ...
                    "url": "<?php echo e(adminUrl('group/unban')); ?>",
                    success: function () {
                        layer.close(layer2);
                        layer.close(layer1);
        ...
        $(".flag").click(function () {
            ...
            $.ajax({
                ...
                "url": "<?php echo e(adminUrl('group/changeFlag')); ?>",
                success: function () {
                    layer.close(layer1);
        ...
        $(".business_type").click(function () {
            ...
            $.ajax({
                ...
                "url": "<?php echo e(adminUrl('group/changeBusinessType')); ?>",
                success: function () {
                    layer.close(layer1);
        ...
        $(".statusMoney").click(function () {
            ...
            $.ajax({
                ...
                "url": "<?php echo e(adminUrl('group/changeStatusMoney')); ?>",
                success: function () {
                    layer.close(layer1);
        ...
        $(".status_in").click(function () {
            ...
            $.ajax({
                ...
                "url": "<?php echo e(adminUrl('group/changeStatusIn')); ?>",
                success: function () {
                    layer.close(layer1);
        ...
        $(".flush_admin").click(function () {
            ...
            $.ajax({
                ...
                "url": "<?php echo e(adminUrl('group/flushAdmin')); ?>",
        ...
        $(".trade_type").click(function () {
            ...
            $.ajax({
                ...
                "url": "<?php echo e(adminUrl('group/changeTradeType')); ?>",
                success: function () {
                    layer.close(layer1);
        ...
        $(".send_user_change").click(function () {
            ...
            $.ajax({
                ...
                "url": "<?php echo e(adminUrl('group/changeSendUserChange')); ?>",
                success: function () {
                    layer.close(layer1);
        ...
        $(".status_follow").click(function () {
            ...
            $.ajax({
                ...
                "url": "<?php echo e(adminUrl('group/changeStatusFollow')); ?>",
                success: function () {
                    layer.close(layer1);
        ...
        $(".xianjing_status").click(function () {
            ...
            $.ajax({
                ...
                "url": "<?php echo e(adminUrl('group/changeStatusXianjing')); ?>",
                success: function () {
                    layer.close(layer1);
        ...
        $(".people_limit").click(function () {
            ...
            $.ajax({
                ...
                "url": "<?php echo e(adminUrl('group/changePeopleLimit')); ?>",
                success: function () {
                    layer.close(layer1);
        ...
        $(".welcome_status").click(function () {
            ...
            $.ajax({
                ...
                "url": "<?php echo e(adminUrl('group/changeWelcomeStatus')); ?>",
                success: function () {
                    layer.close(layer1);
        ...
        $(".limit_one_time").click(function () {
            layer.prompt({title: "欢迎语频率（单位：秒）"}, function (value, index, elem) {
                ...
                $.ajax({
                    "url": "<?php echo e(adminUrl('group/changeLimitOneTime')); ?>",
                    type: "post",
                    data: {
                        _token: '<?php echo e(csrf_token()); ?>',
                        "chat_id": $("input[name='chat_id']").val(),
        ...
        $(".group_num").click(function () {
            layer.prompt({title: "编号"}, function (value, index, elem) {
                ...
                $.ajax({
                    "url": "<?php echo e(adminUrl('group/changeNum')); ?>",
                    type: "post",
                    data: {
                        _token: '<?php echo e(csrf_token()); ?>',
                        "chat_id": $("input[name='chat_id']").val(),
        ...
        $(".setUserTitle").click(function () {
            ...
            layer.prompt({title: "设置管理员头衔"}, function (value, index, elem) {
                ...
                $.ajax({
                    "url": "<?php echo e(adminUrl('group/setUserTitle')); ?>",
                    type: "post",
                    data: {
                        _token: '<?php echo e(csrf_token()); ?>',
                        "chat_id": $("input[name='chat_id']").val(),
        ...
        $(".edit_title").click(function () {
            let index_prompt = layer.prompt({
                ...
                $.ajax({
                    url: "<?php echo e(adminUrl('group/changeTitle')); ?>",
                    type: "post",
                    data: {
                        _token: "<?php echo e(csrf_token()); ?>",
                        "chat_id": $("input[name='chat_id']").val(),
        ...
        $(".edit_rules").click(function () {
            let index_prompt = layer.prompt({
                ...
                $.ajax({
                    url: "<?php echo e(adminUrl('group/changeRules')); ?>",
                    type: "post",
                    data: {
                        _token: "<?php echo e(csrf_token()); ?>",
                        "chat_id": $("input[name='chat_id']").val(),
        ...
        $(".edit_desc").click(function () {
            let index_prompt = layer.prompt({
                ...
                $.ajax({
                    url: "<?php echo e(adminUrl('group/changeDesc')); ?>",
                    type: "post",
                    data: {
                        _token: "<?php echo e(csrf_token()); ?>",
                        "chat_id": $("input[name='chat_id']").val(),
        ...
        $(".key").click(function () {
            ...
            $.ajax({
                ...
                "url": "<?php echo e(adminUrl('group/change')); ?>",
                success: function (data) {
                    layer.msg(data["message"]);
                    layer.close(load);
                },
        ...
        $(".submitTime").click(function () {
            ...
            $.ajax({
                ...
                "url": "<?php echo e(adminUrl('group/setTime')); ?>",
                success: function (data) {
                    layer.msg(data["message"]);
                    layer.close(load);
                },
        ...
        $(".edit_info").click(function () {
            let index_prompt = layer.prompt({
                ...
                $.ajax({
                    url: "<?php echo e(adminUrl('group/changeInfo')); ?>",
                    type: "post",
                    data: {
                        _token: "<?php echo e(csrf_token()); ?>",
                        "chat_id": $("input[name='chat_id']").val(),
        ...
        $(".set_official_admin").click(function() {
            layer.prompt({title: "新增官方账号管理员"}, function (value, index, elem) {
                ...
                $.ajax({
                    "url": "<?php echo e(adminUrl('group/setOfficialAdmin')); ?>",
                    type: "post",
                    data: {
                        _token: '<?php echo e(csrf_token()); ?>',
                        "chat_id": $("input[name='chat_id']").val(),
        ...
        $(".kick_one_user").click(function() {
            layer.prompt({title: "踢出指定用户"}, function (value, index, elem) {
                ...
                $.ajax({
                    "url": "<?php echo e(adminUrl('group/kickOneUser')); ?>",
                    type: "post",
                    data: {
                        _token: '<?php echo e(csrf_token()); ?>',
                        "chat_id": $("input[name='chat_id']").val(),
        ...
        $(".set_admin").click(function () {
            ...
            $("body").off('click', '.setAdmin .submitSure').on("click", ".setAdmin .submitSure", function () {
                ...
                $.ajax({
                    ...
                    "url": "<?php echo e(adminUrl('group/setAdmin')); ?>",
                    success: function (data) {
                        layer.close(load);
                        layer.close(layer1);
        ...
        $(".remove_admin").click(function () {
            ...
            let layer1 = layer.confirm("确定移除该管理？", function () {
                ...
                $.ajax({
                    url: "<?php echo e(adminUrl('group/removeAdmin')); ?>",
                    type: "post",
                    data: {
                        "_token": '<?php echo e(csrf_token()); ?>',
                        "chat_id": $("input[name='chat_id']").val(),
        ...
        $(".leave").click(function () {
            let layer1 = layer.confirm("公群机器人退出该群？", function () {
                ...
                $.ajax({
                    ...
                    "url": "<?php echo e(adminUrl('group/leave')); ?>",
                    success: function (data) {
                        layer.close(layer2);
                        layer.msg(data.message);
        ...
        $(".status_approve").click(function () {
            ...
            $.ajax({
                ...
                "url": "<?php echo e(adminUrl('group/changeStatusApprove')); ?>",
                success: function (data) {
                    layer.msg(data["message"]);
                    layer.close(load);
                },
        ...
        $(".rejectAll").click(function () {
            ...
            $.ajax({
                ...
                "url": "<?php echo e(adminUrl('group/rejectAllApprove')); ?>",
                success: function (data) {
                    layer.msg(data["message"]);
                    layer.close(load);
                },
        ...
        function loadApprovesBack() {
            ...
            $.ajax({
                ...
                url: '<?php echo e(adminUrl("group/approves")); ?>',
        ...
        function loadApproves() {
            ...
            $.ajax({
                ...
                url: '<?php echo e(adminUrl("log/approve/data")); ?>',
                success: function (result) {
        ...
        $(".approves").on("click", ".approve", function() {
            ...
            $.ajax({
                ...
                "url": "<?php echo e(adminUrl('log/approve/agree')); ?>",
                success: function (data) {
                    layer.close(layer1);
        ...
        $(".approves").on("click", ".reject", function() {
            ...
            $.ajax({
                ...
                "url": "<?php echo e(adminUrl('log/approve/reject')); ?>",
                success: function (data) {
                    layer.close(layer1);
        ...
        $(".approves").on("click", ".kick", function() {
            ...
            $.ajax({
                ...
                "url": "<?php echo e(adminUrl('log/approve/kick')); ?>",
                success: function (data) {
                    layer.close(layer1);
        ...
        $(".approves").on("click", ".addCheat", function() {
            ...
            layer.prompt({title: '请输入加入担保黑名单原因', formType: 0}, function (pass, index) {
                ...
                $.ajax({
                    ...
                    "url": "<?php echo e(adminUrl('log/approve/addCheat')); ?>",
                    success: function (result) {
                        layer.close(index_load);
        ...
        $(".declineAndKick").click(function () {
            ...
            $.ajax({
                url: '<?php echo e(adminUrl("log/approve/declineAndKick")); ?>',
                type: "post",
                data: data,
                success: function (result) {
                    layer.close(index_load);
        ...
        $(".declineAndKickAndCheat").click(function () {
            ...
            layer.prompt({title: '请输入加入黑名单原因', formType: 0}, function (pass, index) {
                ...
                $.ajax({
                    url: '<?php echo e(adminUrl("log/approve/declineAndKickAndCheat")); ?>',
                    type: "post",
                    data: data,
                    success: function (result) {
                        layer.close(index_load);
        ...
        $(".clearAllapprove").click(function () {
            ...
            $.ajax({
                url: '<?php echo e(adminUrl("group/approve/clearAllapprove")); ?>',
                type: "post",
                data: data,
                success: function (result) {
                    layer.close(index_load);
        ...
        $(".business_detail_type").change(function () {
            ...
            $.ajax({
                ...
                "url": "<?php echo e(adminUrl('group/changeBusinessDetailType')); ?>",
                success: function () {
                    layer.msg("操作成功");
                },
                error: function (data) {
        ...
        let dataTable4 = $('#dataTable4').DataTable({
            ...
            "ajax": {
                "method": "post",
                "url": "<?php echo e(adminUrl('log/group')); ?>",
                "data": function (d) {
                    return $.extend({}, d, {
                        "_token": "<?php echo e(csrf_token()); ?>",
                        "group_tg_id": $("input[name='chat_id']").val(),
        ...
        $(".trade_rate").click(function () {
            layer.prompt({title: "报备报警比例"}, function (value, index, elem) {
                ...
                $.ajax({
                    "url": "<?php echo e(adminUrl('group/changeTradeRate')); ?>",
                    type: "post",
                    data: {
                        _token: '<?php echo e(csrf_token()); ?>',
                        "chat_id": $("input[name='chat_id']").val(),
